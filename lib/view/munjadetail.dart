...
class MunjaDetail extends StatefulWidget {
  const MunjaDetail({super.key});

  @override
  State<MunjaDetail> createState() => _MunjaDetailState();
}

class _MunjaDetailState extends State<MunjaDetail> {
