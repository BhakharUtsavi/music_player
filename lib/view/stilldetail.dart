...
class StillDetail extends StatefulWidget {
  const StillDetail({super.key});

  @override
  State<StillDetail> createState() => _StillDetailState();
}

class _StillDetailState extends State<StillDetail> {
