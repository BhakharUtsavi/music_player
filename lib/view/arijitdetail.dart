...
class ArijitDetail extends StatefulWidget {
  const ArijitDetail({super.key});

  @override
  State<ArijitDetail> createState() => _ArijitDetailState();
}

class _ArijitDetailState extends State<ArijitDetail> {
